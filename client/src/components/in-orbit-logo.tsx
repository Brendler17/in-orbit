export function InOrbitLogo() {
  return (
    ...
    >
      ...
      <path
        d="M12 0c-.936 0-1.847.107-2.72.31A12.016 12.016 0 00.31 9.28C.107 10.152 0 11.063 0 12c0 6.627 5.373 12 12 12 .936 0 1.847-.107 2.72-.31a12.017 12.017 0 008.97-8.968c.203-.875.31-1.786.31-2.722 0-6.627-5.373-12-12-12zm0 19.515a7.494 7.494 0 01-2.524-.435 7.535 7.535 0 01-4.556-4.555A7.515 7.515 0 1119.515 12 7.515 7.515 0 0112 19.515z"
        fill="url(#paint0_linear_84_261)"
      />
      <path
        d="M12 7.157a4.844 4.844 0 100 9.687 4.844 4.844 0 000-9.687zm0 7.772a2.929 2.929 0 110-5.858 2.929 2.929 0 010 5.858z"
        fill="#FEFCFE"
      />
      <path
        d="M14.524 4.92a7.515 7.515 0 00-9.604 9.605 7.423 7.423 0 01-2.63-1.702A7.408 7.408 0 01.31 9.28 12.016 12.016 0 019.28.31a7.409 7.409 0 013.543 1.98 7.423 7.423 0 011.701 2.63z"
        fill="url(#paint1_linear_84_261)"
      />
      <path
        d="M23.69 14.721a12.016 12.016 0 01-8.97 8.969 7.408 7.408 0 01-3.543-1.98 7.427 7.427 0 01-1.701-2.63 7.515 7.515 0 009.605-9.605c.958.362 1.857.93 2.629 1.702a7.41 7.41 0 011.98 3.544z"
        fill="url(#paint2_linear_84_261)"
      />
      <path
        d="M6.064 20.448a2.511 2.511 0 100-5.023 2.511 2.511 0 000 5.023z"
        fill="url(#paint3_linear_84_261)"
      />
      <path
        d="M17.958 8.554a2.511 2.511 0 100-5.023 2.511 2.511 0 000 5.023z"
